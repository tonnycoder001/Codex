          ...
          <div class="relative px-6 lg:px-8">
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div class="relative rounded-full py-1 px-3 text-sm leading-6 text-white-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                  Announcing our next round of funding. <a href="#" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
                </div>
              </div>
              <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-white-900 sm:text-6xl">Forgetting is hard, remembering is worse</h1>
                <p class="mt-6 text-lg leading-8 text-white-600">Sexual harassment is a crime, and it's a crime that should not be tolerated in any workplace, in any school, in any home.</p>
...
<footer class="bg-white dark:bg-gray-900">
  <div class="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
      <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400">
              ...
              <li class="mb-4">
                  <a href="#" class="hover:underline">Our brand</a>
              </li>
              <li class="mb-4">
  ...
  <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://Teamcoders.com/">Teamcoders™</a>. All Rights Reserved.
      </span>
