...
<div class="isolate bg-white py-24 px-6 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl text-center">
    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Donation Form</h2>
  </div>
  <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
    <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
      ...
      <div class="sm:col-span-2">
        <label for="message" class="block text-sm font-semibold leading-6 text-gray-900">Comment</label>
        <div class="mt-2.5">
      ...
      <div class="flex gap-x-4 sm:col-span-2">
        <div class="flex h-6 items-center">
          ...
          <div class="pt-6">
         <h1 class="text-black font-semibold">Type of donation</h1> 
